...
arguments = [
    ["--images_folder", "custom_datasets/images/objects/pothole", "--dimension", "depth", "--prompts_path", "prompts/pothole.txt", "--num_steps", "20", "--guidance_scale", "3", "--controlnet_conditioning_scale", "1",],
    # ["--images_folder", "custom_datasets/images/objects/pothole_far", "--dimension", "depth", "--prompts_path", "prompts/pothole_far.txt", "--num_steps", "20", "--guidance_scale", "3", "--controlnet_conditioning_scale", "1",],
    # ["--images_folder", "custom_datasets/images/objects/random_objects", "--dimension", "depth", "--prompts_path", "prompts/random_objects.txt", "--num_steps", "20", "--guidance_scale", "3", "--controlnet_conditioning_scale", "1",],
    ["--images_folder", "custom_datasets/images/scenes/INSTSnowRoadDetection", "--dimension", "depth", "--prompts_path", "prompts/INSTSnowRoadDetection.txt", "--num_steps", "20", "--guidance_scale", "3", "--controlnet_conditioning_scale", "1",],
    # ["--images_folder", "custom_datasets/images/scenes/random_scenes", "--dimension", "depth", "--prompts_path", "prompts/random_scenes.txt", "--num_steps", "20", "--guidance_scale", "3", "--controlnet_conditioning_scale", "1",],

    ["--images_folder", "custom_datasets/images/objects/pothole", "--dimension", "normals", "--prompts_path", "prompts/pothole.txt", "--num_steps", "20", "--guidance_scale", "3", "--controlnet_conditioning_scale", "1",],
    # ["--images_folder", "custom_datasets/images/objects/pothole_far", "--dimension", "normals", "--prompts_path", "prompts/pothole_far.txt", "--num_steps", "20", "--guidance_scale", "3", "--controlnet_conditioning_scale", "1",],
    # ["--images_folder", "custom_datasets/images/objects/random_objects", "--dimension", "normals", "--prompts_path", "prompts/random_objects.txt", "--num_steps", "20", "--guidance_scale", "3", "--controlnet_conditioning_scale", "1",],
    ["--images_folder", "custom_datasets/images/scenes/INSTSnowRoadDetection", "--dimension", "normals", "--prompts_path", "prompts/INSTSnowRoadDetection.txt", "--num_steps", "20", "--guidance_scale", "3", "--controlnet_conditioning_scale", "1",],
    # ["--images_folder", "custom_datasets/images/scenes/random_scenes", "--dimension", "normals", "--prompts_path", "prompts/random_scenes.txt", "--num_steps", "20", "--guidance_scale", "3", "--controlnet_conditioning_scale", "1",],
]
